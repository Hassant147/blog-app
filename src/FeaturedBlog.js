...
import img from '../src/Media/featuredSection/img.png';
import img1 from '../src/Media/featuredSection/img1.png';
import img2 from '../src/Media/featuredSection/img2.png';
import img3 from '../src/Media/featuredSection/img3.png';
import img4 from '../src/Media/featuredSection/img4.png';
...
export function FeaturedBlogsSection() {
    ...
    const smallCardsData = [
        { imageUrl: img1, category: "Creative, Digital", title: "Small Card 1" },
        { imageUrl: img2, category: "Tech, Modern", title: "Small Card 2" },
        { imageUrl: img3, category: "Innovation, Trends", title: "Small Card 3" },
        { imageUrl: img4, category: "Design, Art", title: "Small Card 4" }
    ];
